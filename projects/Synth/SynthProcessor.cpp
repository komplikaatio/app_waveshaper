    ...
    mrta::BaseProcessor(paramVector)
{
    ...
    registerParameterCallback(Param::ID::OscillatorSawVol, [this] (float value, bool force) { setOscSawVol(voices, value, force); });
    registerParameterCallback(Param::ID::OscillatorTriVol, [this] (float value, bool force) { setOscTriVol(voices, value, force); });
    registerParameterCallback(Param::ID::OscillatorSinVol, [this] (float value, bool force) { setOscSinVol(voices, value, force); });
    registerParameterCallback(Param::ID::OscillatorVol, [this] (float value, bool force) { setOscVol(voices, value, force); });
    registerParameterCallback(Param::ID::VCA_AttTime, [this] (float value, bool force) { setAttTimeVCA(voices, value); });
    registerParameterCallback(Param::ID::VCA_DecayTime, [this] (float value, bool force) { setDecayTimeVCA(voices, value); });
    registerParameterCallback(Param::ID::VCA_Sustain, [this] (float value, bool force) { setSustainVCA(voices, value); });
    registerParameterCallback(Param::ID::VCA_RelTime, [this] (float value, bool force) { setRelTimeVCA(voices, value); });
    registerParameterCallback(Param::ID::VCF_AttTime, [this] (float value, bool force) { setAttTimeVCF(voices, value); });
    registerParameterCallback(Param::ID::VCF_DecayTime, [this] (float value, bool force) { setDecayTimeVCF(voices, value); });
    registerParameterCallback(Param::ID::VCF_Sustain, [this] (float value, bool force) { setSustainVCF(voices, value); });
    registerParameterCallback(Param::ID::VCF_RelTime, [this] (float value, bool force) { setRelTimeVCF(voices, value); });
    registerParameterCallback(Param::ID::VCF_LFOFreq, [this] (float value, bool force) { setLFOFreqVCF(voices, value); });
    registerParameterCallback(Param::ID::VCF_LFOType, [this] (float value, bool force) { setLFOTypeVCF(voices, static_cast<DSP::SynthVoice::LFOType>(std::round(value))); });
    registerParameterCallback(Param::ID::VCF_Cutoff, [this] (float value, bool force) { setFilterCutoff(voices, value, force); });
    registerParameterCallback(Param::ID::VCF_Reso, [this] (float value, bool force) { setFilterReso(voices, value, force); });
    registerParameterCallback(Param::ID::VCF_Type, [this] (float value, bool force) { setFilterType(voices, static_cast<DSP::SynthVoice::FilterType>(std::round(value)), force); });
    registerParameterCallback(Param::ID::VCF_EnvAmount, [this] (float value, bool force) { setEnvAmountVCF(voices, value, force); });
    registerParameterCallback(Param::ID::VCF_LFOAmount, [this] (float value, bool force) { setLFOAmountVCF(voices, value, force); });
    registerParameterCallback(Param::ID::OutputVol, [this] (float value, bool force) { setOutputVol(voices, value, force); });
}
...
void SynthProcessor::prepare(double sampleRate, int /*samplesPerBlock*/)
{
    synth.setCurrentPlaybackSampleRate(sampleRate);
}

void SynthProcessor::process(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    buffer.clear();
