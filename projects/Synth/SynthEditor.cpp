...
SynthEditor::SynthEditor(mrta::BaseProcessor& p) :
    juce::AudioProcessorEditor(p), processor(p),
    oscParamEditor(processor.getParameterManager(), PARAM_HEIGHT, { Param::ID::OscillatorSawVol, Param::ID::OscillatorTriVol, Param::ID::OscillatorSinVol, Param::ID::OscillatorVol, Param::ID::OutputVol }),
    vcaEnvParamEditor(processor.getParameterManager(), PARAM_HEIGHT, { Param::ID::VCA_AttTime, Param::ID::VCA_DecayTime, Param::ID::VCA_Sustain, Param::ID::VCA_RelTime }),
    vcfEnvParamEditor(processor.getParameterManager(), PARAM_HEIGHT, { Param::ID::VCF_AttTime, Param::ID::VCF_DecayTime, Param::ID::VCF_Sustain, Param::ID::VCF_RelTime }),
    lfoParamEditor(processor.getParameterManager(), PARAM_HEIGHT, { Param::ID::VCF_LFOFreq, Param::ID::VCF_LFOType }),
    filterParamEditor(processor.getParameterManager(), PARAM_HEIGHT, { Param::ID::VCF_Cutoff, Param::ID::VCF_Reso, Param::ID::VCF_Type, Param::ID::VCF_EnvAmount, Param::ID::VCF_LFOAmount }),
...
void SynthEditor::setupLabel(juce::Label& label)
{
