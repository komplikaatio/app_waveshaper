...
MidiHandlerEditor::MidiHandlerEditor(mrta::BaseProcessor& p) :
...
MidiHandlerEditor::~MidiHandlerEditor()
{
}

void MidiHandlerEditor::paint(juce::Graphics&)
{
}

void MidiHandlerEditor::resized()
{
